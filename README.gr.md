...
Δύο shims τυλίγουν το ίδιο αρχείο για όσους προτιμούν τον launcher της πλατφόρμας
τους. Δεν έχουν δική τους λογική — απλώς μεταφράζουν τα flags στις μεταβλητές
περιβάλλοντος που το `openflow.ts` ήδη διαβάζει.
...
**Στα Windows το shim μπορεί να αρνηθεί να ξεκινήσει:** το PowerShell από προεπιλογή
...
να τα προσπεράσετε. Για να χρησιμοποιήσετε παρ' όλα αυτά το shim, επιτρέψτε τα τοπικά
