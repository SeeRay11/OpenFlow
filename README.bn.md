...
দুটি shim ওই একই ফাইলকে মুড়ে রাখে, যারা নিজের প্ল্যাটফর্মের লঞ্চার পছন্দ করেন তাঁদের জন্য।
এদের নিজস্ব কোনো লজিক নেই — এরা কেবল ফ্ল্যাগগুলোকে সেই এনভায়রনমেন্ট ভেরিয়েবলে অনুবাদ করে যা
`openflow.ts` আগে থেকেই পড়ে।
...
**Windows-এ shim চালু হতে অস্বীকার করতে পারে:** PowerShell ডিফল্টভাবে স্বাক্ষরবিহীন লোকাল
...
পথ। তবু shim ব্যবহার করতে চাইলে নিজের অ্যাকাউন্টের জন্য লোকাল স্ক্রিপ্ট অনুমোদন করুন, আর ফাইলটি
