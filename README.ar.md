...
‏هناك غلافان (shims) يلفّان الملف نفسه لمن يفضّل مُشغِّل نظامه. ولا يحتويان على أي منطق
خاص بهما — فهما يترجمان الرايات إلى متغيرات البيئة التي يقرؤها `openflow.ts` أصلًا.
...
**على Windows قد يرفض الغلاف الانطلاق:** لا يشغِّل PowerShell افتراضيًا السكربتات
...
openflow.ts` لا يخضع لأي منهما وهو أقصر طريق لتجاوزهما معًا. ولاستعمال الغلاف رغم ذلك،
اسمح بالسكربتات المحلية لحسابك أنت، وارفع الحجب عن الملف إن كان قادمًا من ملف ZIP:
