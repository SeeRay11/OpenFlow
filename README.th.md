...
มี shim สองตัวที่ห่อไฟล์เดียวกันนี้ไว้ สำหรับคนที่ถนัดตัวเรียกใช้ของแพลตฟอร์มตัวเอง ทั้งสอง
ไม่มีตรรกะของตัวเอง — เพียงแปลงแฟล็กให้เป็นตัวแปรสภาพแวดล้อมที่ `openflow.ts` อ่านอยู่แล้ว
...
**บน Windows ตัว shim อาจปฏิเสธที่จะเริ่มทำงาน:** โดยค่าเริ่มต้น PowerShell จะไม่รันสคริปต์
...
ต้องการใช้ shim ให้อนุญาตสคริปต์ในเครื่องสำหรับบัญชีของคุณเอง และปลดบล็อกไฟล์หากมันมาจาก ZIP:
