...
Два шими загортають той самий файл — для тих, кому звичніший лаунчер власної
платформи. Власної логіки вони не мають: вони лише перетворюють прапорці на змінні
середовища, які `openflow.ts` і так читає.
...
**У Windows шим може відмовитися запускатися:** PowerShell типово не виконує
...
жодне з цих обмежень і є найкоротшим шляхом повз обидва. Щоб усе ж скористатися
шимом, дозвольте локальні скрипти для власного облікового запису та зніміть
